...
async def start_stream(
    ...
    if await is_active_chat(CallbackQuery.message.chat.id):
        ...
        await mystic.delete()
        cap = f"🎥<b>__التشغيل:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n💡<b>__معلومات:__</b> [احصل على معلومات إضافية](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤**__طلب من:__** {CallbackQuery.from_user.mention}"
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"💡<b>بدء تشغيل الصوت: </b> [نظرا للصوت عبر Telegram]({link})\n⏳<b>__المدة:__</b> {duration_min} \n👤<b>__طلب من:__ </b>{message.from_user.mention} \n🚧<b>__في قائمة الانتظار:__</b> <b>#{position}!</b>"
            ),
